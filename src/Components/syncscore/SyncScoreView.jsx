        ...
        } */}
            {
                me.role == "trainer" ?
                    <div style={{ fontSize: "35px" }}>
                        <span style={{ "marginLeft": "0px" }}>me: {props.my_name}</span>
                        <span style={{ "marginLeft": "200px" }}>my trainee: {props.your_name}</span>
                    </div>
                    :
                    <div style={{ fontSize: "35px" }}>
                        <span style={{ "marginLeft": "0px" }}>me: {props.my_name}</span>
                        <span style={{ "marginLeft": "200px" }}>my trainer: {props.your_name}</span>
                    </div>
            }
            <br />
